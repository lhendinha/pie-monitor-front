...
export const HIERARQUIA_PAPEIS: Papel[] = ["user", "financeiro", "manager", "admin", "super_admin"];
...
export const PAPEIS_CONVIDAVEIS: Papel[] = HIERARQUIA_PAPEIS.filter((p) => p !== "super_admin");
