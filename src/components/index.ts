...
export { IconeHistorico, IconeArrastar, IconeBusca, IconeCalendario, IconeSeta, IconeChevron, IconeSino, IconeLixeira, IconeLapis, IconePlus, IconeGrupo, IconeCheck, IconeAlerta, IconeCadeado } from "./Icons";
