...
export { IconeHistorico, IconeArrastar, IconeBaixar, IconeBusca, IconeCalendario, IconeClientes, IconeSeta, IconeChevron, IconeLink, IconeEnviar, IconeSino, IconeLixeira, IconeLapis, IconePlus, IconeGrupo, IconeCheck, IconePessoa, IconeMover, IconeAlerta, IconeCadeado, IconeOlho, IconeOlhoCortado, IconeX } from "./Icons";
...
export { default as ConfirmacaoDeConclusaoEmLote } from "./ConfirmacaoDeConclusaoEmLote";
