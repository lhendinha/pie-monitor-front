...
export { IconeHistorico, IconeArrastar, IconeBusca, IconeCalendario, IconeSeta, IconeChevron, IconeSino, IconeLixeira, IconeLapis, IconePlus, IconeGrupo } from "./Icons";
