...
export { IconeHistorico, IconeArrastar, IconeBusca, IconeCalendario, IconeClientes, IconeSeta, IconeChevron, IconeLink, IconeEnviar, IconeSino, IconeLixeira, IconeLapis, IconePlus, IconeGrupo, IconeCheck, IconeAlerta, IconeCadeado, IconeOlho, IconeOlhoCortado } from "./Icons";
