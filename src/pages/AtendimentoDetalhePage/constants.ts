/** As TRÊS abas da tela, como nas irmãs de processo e cliente.
 *
 * A primeira é o padrão, e é o que a tela sempre foi: a conversa registrada.
 *
 * 🔴 **"Detalhes" fica em SEGUNDO, e não em primeiro** -- ao contrário de
 * processo e cliente, onde ela abre. `abaValida` devolve `abas[0].id`, então
 * pôr Detalhes na frente faria abrir um atendimento mostrar o formulário em
 * vez da conversa. Quem abre um atendimento normalmente quer LER o que
 * aconteceu, não editar o assunto. A consistência com as telas irmãs é de
 * TER abas, não de qual vem primeiro -- e lá a primeira também é a que
 * responde "o que é isto", que aqui é a conversa.
 *
