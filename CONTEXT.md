...
- **Ordem de Fase/Situação por drag and drop**, não mais um campo numérico
  ...
  **Limitação conhecida e aceita, não corrigida (achado na revisão
  ...
  (para Fase/Situação o backend lê a partição inteira por chamada de qualquer forma; processos, documentos e clientes passaram a ler do índice estreito em 05/09/2026 --
